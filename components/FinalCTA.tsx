  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-600 to-pink-600">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl sm:text-2xl text-white/90 mb-10 text-balance">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a 
            ...
            target="_blank"
            className="bg-white text-primary px-8 py-4 rounded-full text-lg font-bold hover:bg-gray-100 transition shadow-lg hover:shadow-xl w-full sm:w-auto inline-flex items-center justify-center"
          >
        ...
        <div className="mt-12 pt-8 border-t border-white/20">
          <p className="text-white/80 mb-4">Fast delivery • No monthly fees • Lifetime validity</p>
        </div>
      </div>
    </section>
  )
